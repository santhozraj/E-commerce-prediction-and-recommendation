...
st.title(":orange[**E-commerce-prediction-and-recommendation**]")
...
if selected_page == "DataFrame":
    ...
    path = "D:/Guvi/Data Science/project datas/classification_data.csv"
    df = pd.read_csv(path)
    st.dataframe(df)
    ...
    st.title(":blue[Algorithm results]")
...
df1 = pd.read_csv("C:/Users/santh/Desktop/project/df1.csv")  
...
model = load_model("C:/Users/santh/Desktop/project/random_forest_model.pkl")
...
if selected_page == "Recommendations":
    ...
    movies_data = pd.DataFrame.from_dict(pickle.load(open('C:/Users/santh/Desktop/project/movies.pkl', 'rb')))
    similarity_data = pickle.load(open('C:/Users/santh/Desktop/project/similarity.pkl', 'rb'))
